function scrollY(box){	//Y轴滚动
	...
	var scrollY='<div class="scrollboxs" style="width:10px;position:absolute;top:0px;right:0px;z-index:0;background-color:none;height:'+H+'px;border-radius: 20000px;z-index: 99999999999;">';
		scrollY+='<div id="scrollbtn" style="width:100%;height:'+btnH+'px;margin:0 auto;position:relative;cursor:pointer;border-radius:2000px;" tops="0">';
		scrollY+='<div style="background-color:rgba(134, 133, 133, 0.3);;position:absolute;width:10px;left:0px;height:100%;border-radius:2000px;"></div>';
		scrollY+='</div></div>';
